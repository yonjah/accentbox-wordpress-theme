...
(2) All other parts of the theme including, but not limited to the CSS code, images, and design are licensed according to the license purchased. More Info here: 
http://mythemeshop.com/terms-and-conditions/